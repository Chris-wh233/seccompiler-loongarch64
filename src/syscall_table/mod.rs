...
mod tests {
    ...
    fn test_get_syscall_nr() {
        ...
        // These optional generic syscall ABIs are not enabled for LoongArch.
        assert!(instance_loongarch64.get_syscall_nr("renameat").is_none());
        assert!(instance_loongarch64.get_syscall_nr("getrlimit").is_none());
        assert!(instance_loongarch64.get_syscall_nr("setrlimit").is_none());
        assert!(instance_loongarch64.get_syscall_nr("memfd_secret").is_none());
    }
}
